...
techshop.config(['$routeProvider', '$locationProvider', function($routeProvider,$locationProvider){
      ...
      $routeProvider
          ...
          .when('/daniel340',{
                templateUrl: 'pricing-table-daniel340.html'
          })
          .when('/nerea341',{
                templateUrl: 'pricing-table-nerea341.html'
          })
          .when('/paula342',{
                templateUrl: 'pricing-table-paula342.html'
          })
          .when('/paula360',{
                templateUrl: 'pricing-table-paula360.html'
          })
          .when('/carmen343',{
                templateUrl: 'pricing-table-carmen343.html'
          })
          .when('/miriam345',{
                templateUrl: 'pricing-table-miriam345.html'
          })
          .when('/gw-anker',{
